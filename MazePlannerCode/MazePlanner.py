...
class MazeGUI:
    ...
    def _initSearchTools(self):
        ...
        weightedAstarButton = Radiobutton(searchFrame, text = "Weighted A*",
                                     variable=self.searchType, value="weightedastar", state=NORMAL)
        ...
        weightedAstarButton.grid(row=5, column=1, sticky=W)
